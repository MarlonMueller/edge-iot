...
#include "birdnet_extended_int8_coefficient.hpp"

#define TAG "BIRDNET"

using namespace dl;
using namespace layer;
using namespace birdnet_extended_int8_coefficient;

// input_exponent: ['-7']

// evaluation: acc_train: 85.68507157464212, acc_train_quant: 80.31697341513292, acc_test: 81.63265306122449, acc_test_quant: 74.08163265306122

class BIRDNET_EXTENDED_INT8 : public Model<int8_t>
{
private:
...
public:
    ...
    BIRDNET_EXTENDED_INT8() :
        ...
        max_pooling2d(MaxPool2D<int8_t>({2,1}, PADDING_VALID, {}, 2, 1, "max_pooling2d")),
        ...
        max_pooling2d_1(MaxPool2D<int8_t>({3,1}, PADDING_VALID, {}, 3, 1, "max_pooling2d_1")),
        ...
        max_pooling2d_2(MaxPool2D<int8_t>({1,2}, PADDING_VALID, {}, 1, 2, "max_pooling2d_2")),
