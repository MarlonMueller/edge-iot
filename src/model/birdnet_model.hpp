...
public:
    ...
    BIRDNET() :
        conv1(Conv2D<int16_t>(-14, get__conv1_conv_filter(), get__conv1_conv_bias(), get__conv1_conv_activation(), PADDING_NOT_SET, {0,0,0,0}, 1, 3, "conv1")),
        ...
        pool2(MaxPool2D<int16_t>({2}, PADDING_NOT_SET, {0,0,1,1}, 2, 2, "pool2")),
        ...
        pool3(MaxPool2D<int16_t>({2}, PADDING_VALID, {}, 2, 2, "pool3")),
