...
public:
    ...
    BIRDNET() :
        conv1(Conv2D<int8_t>(-7, get__conv1_conv_filter(), get__conv1_conv_bias(), get__conv1_conv_activation(), PADDING_VALID, {}, 1, 2, "conv1")),
    ...
    void build(Tensor<int8_t>& input) {
        ...
        this->flatten.build(this->pool2.get_output());
