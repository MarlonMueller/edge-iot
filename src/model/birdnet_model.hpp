...
public:
    ...
    BIRDNET() :
        conv1(Conv2D<int8_t>(-6, get__conv1_conv_filter(), get__conv1_conv_bias(), get__conv1_conv_activation(), PADDING_VALID, {}, 2, 2, "conv1")),
        
        pool1(MaxPool2D<int8_t>([1, 3], PADDING_VALID, {}, 1, 3, "pool1")),
        
        conv2(Conv2D<int8_t>(-6, get__conv2_conv_filter(), get__conv2_conv_bias(), get__conv2_conv_activation(), PADDING_VALID, {}, 1, 1, "conv2")),
        
        pool2(MaxPool2D<int8_t>([1, 5], PADDING_VALID, {}, 1, 5, "pool2")),
        
        conv3(Conv2D<int8_t>(-7, get__conv3_conv_filter(), get__conv3_conv_bias(), get__conv3_conv_activation(), PADDING_VALID, {}, 1, 1, "conv3")),
        
        pool3(MaxPool2D<int8_t>([1, 3], PADDING_VALID, {}, 1, 3, "pool3")),
        
        flatten(Flatten<int8_t>("flatten", false)),
        
        fc1(FullyConnected<int8_t>(-4, get__fc1_gemm_filter(), get__fc1_gemm_bias(), get__fc1_gemm_activation(), true, "fc1")),
        
        fc2(FullyConnected<int8_t>(-3, get__fc2_gemm_filter(), get__fc2_gemm_bias(), get__fc2_gemm_activation(), true, "fc2")),
